...
mod tests {
    ...
    /// the frame field. Regression test for issue #25: a title's chapter marks
    ...
    fn bcd_ntsc_timecode_is_not_literal_seconds() {
        ...
        // 00:01:02:00 -> 1860 frames -> 62.062 s (the issue #25 chapter 2 value).
    ...
    fn pgc_parses_duration_from_correct_offset() {
        ...
        // Reading the BCD as literal seconds (7170.0) was the issue #25 bug.
    ...
    /// Regression test for issue #25 (NTSC chapter drift).
    ///
