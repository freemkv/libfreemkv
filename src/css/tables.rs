...
/// Table 1: content-cipher substitution table, `plain = TAB1[cipher] ^ keystream`
/// (used by descramble/recover in lfsr.rs and keyless.rs).
...
/// Table 4: permutes the LFSR0 output byte (`o0 = TAB4[o0]`).
...
/// in the key-recovery fallback ([`super::keyless`]).
